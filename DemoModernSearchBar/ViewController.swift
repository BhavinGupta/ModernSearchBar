...
//  DemoModernSearchBar
//
//  Created by Bhavin Gupta on 17/05/17.
...
class ViewController: UIViewController, ModernSearchBarDelegate {
    ...
    @IBOutlet weak var lblSearchStr: UILabel!
    ...
    //MARK:- MODERN OPTIONNAL DELEGATE METHODS
    ...
    func onClickItemSuggestionsView(item: String) {
        ...
        self.lblSearchStr.text = item
        self.modernSearchBar.text = item
        self.modernSearchBar.resignFirstResponder()
    }
    ...
    func onClickItemWithUrlSuggestionsView(item: ModernSearchBarModel) {
        ...
        self.lblSearchStr.text = item.title
    ...
    //MARK:- CONFIGURE SEARCH BAR (TWO WAYS) METHODS
    ...
    //MARK:- CUSTOM DESIGN (WITH ALL OPTIONS) METHODS
    ...
    //MARK:- Making Search Bar Awesome METHODS
